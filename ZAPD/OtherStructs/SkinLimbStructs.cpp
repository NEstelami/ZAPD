...
std::string Struct_800A598C::GetBodySourceCode() const
{
	...
	Globals::Instance->GetSegmentedPtrName(unk_8, parent, unk_8_Str);
	Globals::Instance->GetSegmentedPtrName(unk_C, parent, unk_C_Str);
...
std::string Struct_800A5E28::GetBodySourceCode() const
{
	...
	std::string unk_8_Str;
	Globals::Instance->GetSegmentedPtrName(unk_4, parent, unk_4_Str);
	Globals::Instance->GetSegmentedPtrName(unk_8, parent, unk_8_Str);
