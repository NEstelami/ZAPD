...
const std::unordered_map<uint32_t, std::string> csOoTEnumNameToString = {
	ENUM_TO_STRING(CS_CMD_PLAYER_CUE),     ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_0),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_1),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_1),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_0),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_0),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_4),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_3),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_1),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_1),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_1),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_4),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_2),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_3),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_1),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_4),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_4),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_1),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_1),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_8_0),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_6),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_7),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_4),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_7),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_8),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_7),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_8),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_7),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_9),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_10), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_8),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_9),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_8),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_4),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_2),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_4),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_9),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_11), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_10),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_9),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_11),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_10), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_12),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_3),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_4),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_5),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_12),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_10), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_13),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_13), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_14),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_11), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_14),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_15), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_12),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_11), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_7),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_5),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_16), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_2_13),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_3_12), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_5),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_4_8),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_5_6),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_6_7),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_15),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_0_16), ENUM_TO_STRING(CS_CMD_ACTOR_CUE_1_17),
	ENUM_TO_STRING(CS_CMD_ACTOR_CUE_7_6),  ENUM_TO_STRING(CS_CMD_ACTOR_CUE_9_0),
...
const std::string csOoTTextTypes[] = {
	"CS_TEXT_NORMAL",     "CS_TEXT_CHOICE",        "CS_TEXT_OCARINA_ACTION",
	"CS_TEXT_GORON_RUBY", "CS_TEXT_ZORA_SAPPHIRE",
};
