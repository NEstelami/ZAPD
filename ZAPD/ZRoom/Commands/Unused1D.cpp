...
Unused1D::Unused1D(ZRoom* nZRoom, std::vector<uint8_t> rawData, int32_t rawDataIndex)
	: ZRoomCommand(nZRoom, rawData, rawDataIndex)
{
}

string Unused1D::GenerateSourceCodePass1(string roomName, int32_t baseAddress)
{
