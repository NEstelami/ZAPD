...
ZRoomCommandUnk::ZRoomCommandUnk(ZRoom* nZRoom, std::vector<uint8_t> rawData, int32_t rawDataIndex)
...
string ZRoomCommandUnk::GenerateSourceCodePass1(string roomName, int32_t baseAddress)
{
...
string ZRoomCommandUnk::GenerateSourceCodePass2(string roomName, int32_t baseAddress)
{
	return "";
}
