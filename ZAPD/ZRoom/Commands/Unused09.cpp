...
Unused09::Unused09(ZRoom* nZRoom, std::vector<uint8_t> rawData, int32_t rawDataIndex)
	: ZRoomCommand(nZRoom, rawData, rawDataIndex)
{
}

string Unused09::GenerateSourceCodePass1(string roomName, int32_t baseAddress)
{
