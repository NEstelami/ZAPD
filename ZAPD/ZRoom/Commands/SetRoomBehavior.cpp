...
SetRoomBehavior::SetRoomBehavior(ZRoom* nZRoom, std::vector<uint8_t> rawData, int32_t rawDataIndex)
...
string SetRoomBehavior::GenerateSourceCodePass1(string roomName, int32_t baseAddress)
{
