...
string SetStartPositionList::GenerateSourceCodePass1(string roomName, int32_t baseAddress)
{
	string sourceOutput = "";
...
string SetStartPositionList::GenerateSourceCodePass2(string roomName, int32_t baseAddress)
{
	return "";
}
