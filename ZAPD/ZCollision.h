...
public:
	...
	PolygonEntry(const std::vector<uint8_t>& rawData, int32_t rawDataIndex);
};
...
public:
	...
	VertexEntry(const std::vector<uint8_t>& rawData, int32_t rawDataIndex);
};
...
public:
	...
	WaterBoxHeader(const std::vector<uint8_t>& rawData, int32_t rawDataIndex);
};
...
public:
	...
	CameraPositionData(const std::vector<uint8_t>& rawData, int32_t rawDataIndex);
};
...
public:
	...
	CameraDataList(ZFile* parent, const std::string& prefix, const std::vector<uint8_t>& rawData,
	               int32_t rawDataIndex, int32_t polyTypeDefSegmentOffset, int32_t polygonTypesCnt);
};
